...
In Wallonia, the altitude varies between 100 and 700m. The walloon forest covers 554 600 Ha. The norway spruce stand occuped 139 600 Ha \citep{alderwerield_2015}. For this study, we selected only spruce trees over 15 m and we have worked on %nombre Ha total 
Ha. Two thirds of the Walloon spruce forest is located above 400m altitude
The Wallon climate is continental(\citep{Metzger 2005}. %integrer figure climat
...
In the Vosges, the elevation is between 200m and 1300m. The vosgian forest occupies 291 000 Ha. The norway spruce forest covers 39 000 Ha (\citep{Inventaire France}.
...
We used digital surface model (DEM) data from the Copernicus Land Monitoring Service (XX cite DEM)  at a resolution of 20mX20m for all elevation data and slope calculations
...
\begin{itemize}
	...
	\the probability of presence of bark beetles
...
The variation of the probability of presence of bark beetles for Wallonia and Vosges for the period 2017-2021 is described in the figure \ref{fig:alti_sco}. The altitude has been subdivided into the same 12 elevation classes for both regions. The graphs corresponding to the variation of the probability of presence in Wallonia are in the upper part of the figure and those for the Vosges in the lower part.

\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{Wall_vs_vosges.png}
	\caption{XXXXAPragraphe_precedent???.}
	\label{fig:alti_sco}
\end{figure}
