...
This paper aims to assess the evolution of the bark beetle crisis during the 2017-2022 period in the Walloon and  Grand-Est spruce forest with remote sensing approach.
...
In Ardennes, since the beginning of the crisis, the dieback rate is gradually decreasing when altitude is increasing.
...
The north-facing slope are significantly  more  affected than the plateau or the south-facing slopes.
...
As opposed to the Ardenne,In the Vosges,, the plateau are significantly more impacted than the north and south-facing slope.
\begin{table}[htbp]
...
However in Europe and in north America, Gazol \citep{gazol_2017} observed that species that grow in drier condition area are more resilient to drought.
