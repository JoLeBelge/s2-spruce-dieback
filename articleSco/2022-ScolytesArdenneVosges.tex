...
\begin{figure}
	...
	\caption{Grouping of natural regions according to the temperature and precipitation of the growing season to form three groups: Ardennes (blue), Plains (red) and Vosges (orange). }
...
The evolution of the crisis differs between these three regions \ref{evol_gen}.

In the Ardennes, the peak of attack is reached in 2019.
The maximum of the ratio of area touched by bark beetles is 3,4\%. 
A begin of decrease is started in 2021.

In the Vosges, the peak is not yet reached.
However, the maximum ratio of area affected by bark beetlmes is inferior of 1,8\%.
...
Plaines  & 13665 Ha                                                                                              & 25 552 Ha                                                                         \\ \hline
Ardennes & 13435 Ha                                                                                              & 101 600 Ha                                                                        \\ \hline
Vosges   & 4540 Ha                                                                                               & 101 065 Ha                                                                        \\ \hline
\end{tabular}
\end{table}
...
The graphs corresponding to the variation of the probability of presence in Ardennes are in the upper part of the figure,the Vosges in middle part and for the Plaines in the lower part.
}
	\label{alti_sco}
\end{figure}
...
\centering
    ...
    \caption{Proportion area affected by bark beetle attacks in relation to topography orientation. The north slope and south slope are affected similarly by bark beetle in Ardennes and in the Vosges}
	\label{ss_sco}
\end{figure}
...
explain that the bark beetle attack more in south slope.
However, our result show that there is no more attack on south slope than in north slope.
Bark beetle attack norway spruce with same proportion south slope and north slope in the Ardennes and in the Vosges.
