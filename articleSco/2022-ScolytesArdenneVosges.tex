...
Global changes imply an increase of disturbances in the forest environment.Frequency and intensity of abiotic (fire, wind, drough) and biotic (pest invasion) will be more and more recurrent \citep{Lindner_climate_2010}. Since one decade,principals timber species are affected by sanitary crisis.%L'épicéa est une essence naturellement présente dans une partie du Grand-Est et intoduite en Wallonie. Cette espece présente dans toute l'Europe de l'est et du nord. Cette essence résineuse importante pour l'industrie du bois mondiale 
