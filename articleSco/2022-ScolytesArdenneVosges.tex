...
Global changes are increasing the risk of disturbances in forest environment: frequency and intensity of abiotic events (fire, storm, drough) and health problems (diseases and pest invasion) will be more recurrent \citep{lindner_climate_2010}.
...
Indeed, the precipitation are its primary water source \citep{tjoelker_outline_2007} and lack of water induces stress that affect growth and health of the tree.
Moreover, its major pest, the bark beetle (\textit{Picea abies L. Karst}), causes important outbreaks after storm, which provide breeding material e.g. windfalls, or after severe drought that weaken trees.
...
It has higlighted the need of improving our understanding of both Norway spruce and bark beetle autecology and synecology for minimising the impact of bark beetle on spruce stands with adapted management methods.
...
Then, we roughly analyse the relationship between the level of bark beetle damages and some main environmental parameters such as altitude and topography in order to determine the most sensitive forest sites where Norway spruce sylviculture should no longer be considered..


\section{Material and methods}
\subsection{Study area}

The study area covers in Wallonia (south of Belgium) and in the Grand-Est (north-east of France).
The Walloon forest covers 554,600 ha and  Norway spruce stands occupy quarter of this forest \citep{lejeune_ep_2022}.  
...
Plains are characterized by the lowest rainfall during the growing season( $<$ 400 mm) and the highest mean temperature during the growing season ( $>$ 15 °C);
ecoregions with rainfall between 400 mm and 450 mm and temperature (15,5°C) correspond to bioclimatic area of the lower Ardenne.
...
These three regions also differ in their altitude wich can be considered as an imperfect proxy for climate
...
Piedallu \citep{piedallu_spatial_2022}confirmed this observation in the Vosges.
