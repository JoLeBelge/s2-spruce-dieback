...
Its major pest is bark beetle (\textit{Ips typographus}) that cause important outbreak after storm, which provide breeding material (windfalls), or after severe drougth that weaken trees.
...
When the conditions are favourable (hot climate or many stressed trees), bark beetles population can progress in a epidemic phasis during which even healthy trees are massively attacked \citep{kautz_individual_2014}.
...
This paper aims at studying the dynamic of 2017-2021 bark beetle outbreak in Wallonia (Belgium) and in the Grand-Est (France).
We analyse the relationship between spruce, bark beetle and environmental conditions in order to determine the most sensitive forest sites where spruce should not be replanted.



%Since the launch of Copernicus project satellites, the are a increasing of development of the vegetation indices.
% stade gris et rouge de l'attaque - sanitary cutting pour endiger l'épidémie
% enlever toute référence à chalcographe - plus simple dans un premier temps. enlever ips typographus et remplacer par bark beetle pour homogenéiser le texte
...
%  Following these events, foresters have asked themselves about certain topographical factors that seem to have strongly influenced bark beetle attacks. 
% ça c'est dans les conclusion qu'il faut l'écrire, pas dans l'into
...
These two  regions have been divided with natural regions. We form three group in fonction de precipitation and temperature of this natural regions (Figure \ref{fig:clim}).
...
%In the Grand-Est, the major part of the norway spruce stand is located in the 3 naturals regions of the Vosges (Vosges Gréseuses, Vosges crstallines, les collines sous-vosgiennes).
...
It was introduced in the low elevation Vosges and in  all part of the Ardenne and the Plains. 
