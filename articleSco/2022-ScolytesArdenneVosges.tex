...
The Grand-Est forest occupies 1939,000 ha. 
...
The climate variables for Wallonia have been provided by the Institut Royal Météorologique and come from the data base Digitalis \citep{piedallu_presentation_2014} for the Grand-Est.
...
The Plains is all of natural region temperature between 15.5°C and 18°C and with precipitation between 300 mm and 400 mm.
...
We have used the digital surface model data from the Copernicus Land Monitoring Service \citep{DEM_copernicus}  at a resolution of 25m for all altitude data and slope calculations.
...
South-facing orientations are slope greater than  20\% facing south with a hot microclimate.
In this orientation the air is warmer and drier and the temperature difference between day and night is greater.
Based on this definition and on the DEM, we produced topographic orientation  maps for Wallonia and the Grand-Est.
...
The forest managers of the two country drew our attention to the variables that seemed to influence spruce dieback.
According to them, the south-facing slope and altitude influence the dieback.
Altitude is a reflect of the climate.
...
population develop favorably with warm \citep{annila_influence_1969, baier_phenipscomprehensive_2007, jonsson_2009, marini_climate_2012} and increase the susceptibility of Norway spruce to the attack of bark beetle \citep{wermelinger_ecology_2004, netherer_waterlimiting_2015}.
If we follow this theory, there is more dead Norway spruce in low altitude and in south-facing slope in the three climatic areas. 
We decide to try the hypothesis of the forest manager that seem correspond to the literature. 
We analyse the result of sanitary map in function of the altitude and the topographic orientations to respond and help the forest manager in the crisis management.
...
For this study, we have worked on 101,600 Ha of spruce in Ardenne, on 26,327 ha of spruce in the Vosges and on 25,552 Ha in the Plains of spruce in the Grand-Est region.
...
The altitude by 100m classes and kept the three topographic orientations classes..
