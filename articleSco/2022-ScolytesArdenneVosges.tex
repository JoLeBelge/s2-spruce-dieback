...
The forest managers drew our attention to the variables that seemed to influence spruce dieback.
According to them, the altitude and the south-facing slope influence the dieback.
...
population is favorably developed with warm.
...
These two factors are altitude and topographic orientation. We broke down the altitude by 100m classes and kept the three topographic orientations classes defined by \cite{Delvaux_galoux}.
