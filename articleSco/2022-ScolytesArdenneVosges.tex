...
The photo-interpretation of spruce stand crossed with the spruce health map shows when the spruce health map predicts a decline, the dieback is confirmed by the orthophotoplan in 86.1 \%  of the verified spots area (table \ref{tab_confu_matrix}).
...
The three bioclimatic regions were not equally impacted by spruce mortalities : 
...
In the Ardenne, the maximum of NCDD is observed in 2018 with also low precipitation. A second major peak occurred in 2020 but with heavy rainfall.
...
The variation of the dieback rate during 2017-2022  for the three bioclimatic regions shows an important effect of altitude but with some difference according to the region (Figure \ref{alti_sco}). More dieback was observed at low altitude :  at the height of the crisis, the annual mortality rate exceeded 20\% each year in the altitude class under 300 m.
...
However, we found that the Vosges lost 5.4\% of their spruce area. Nonetheless, according to vulnerability maps of \cite{piedallu_spatial_2022} , 33\% of spruce stands are located in areas at high risk of dieback. It is therefore likely that new stands will dieback in the years to come.
...
A long period without rain causes intense stress to the trees, weakening them. These conditions allow bark beetles to swarm and penetrate the bark of weakened trees more easily. 
...
However, for the year 2020, in Ardenne the damage is less important than in 2018 while the NCDD are very close. This difference in damage could be explained by higher rainfall in 2020 compared to 2018 in this bioclimatic area. 

Few articles deal with such long time series but our results can be compared to some estimates of annual bark beetle damage made at the scale of administrative regions.
According to \cite{nardi_drought_2022}, the damage during 2018 is assessed at 1185 ha for the Grand-Est based on remote sensing methodology. In our health map for the year 2018, we found a total 1360 ha attacked in this administrative region.
In Wallonia, \cite{saintonge_situation_2022} estimate that the area of spruce attacked by bark beetle between 2018 and 2021 in Wallonia is around 5,000 ha, based on sales catalogues in public forests, and multiplying the volumes by two to account for private forests.
However, this estimate does not take into account unharvested dead spruce.
Moreover, the conversion of marked volume to surface areas using the average volume per hectare is questionable in the case of bark beetle attacks.
In this administrative area, for the period 2018-2021, the area of spruce lost  is estimated at 13,000 ha according to our health map.

%In the Plains, since the first year of the study, the new dieback rate has increased until it reached its peak in 2020. 
...
In contrast, pure even-aged spruce stands of the Plains and Ardenne are significantly more sensible to pests attacks \citep{faccoli_composition_2014,jactel_2021} than the spruces growing in the mixed forests of the Vosges.
...
In Ardenne and in the Plains, Norway spruce occurs principally in pure even-aged stands (respectively 4,35\% and 10 \% are mixed stand (IPRFW (2022)and   \citep{IGN2022})%fairedemandeà jerome)
