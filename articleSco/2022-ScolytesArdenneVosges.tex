...
The evolution of the crisis differs between the three near regions (Figure \ref{evol_gen}).
The first major dieback took place in the Plaines in 2018. One year later, the important damage have begun in 2019 in the Vosges and in the Ardenne.  
...
\begin{figure}
   ...
   \includegraphics[width=\textwidth]{Annual_evol_Ardennes_vosges_plaines.png}
    \caption{Proportion of norway spruce area affected by bark beetle. Plaines region in red, Ardenne in blue and Vosges in }
    \label{evol_gen}
\end{figure}
...
The majority of spruce in the Plaines is located in low altitude under 400m of altitude in contrast with the Ardenne and the Vosges where the majority of nowrway spruce stand grow above 400m. 
...
The graphs corresponding to the variation of the probability of presence in Ardenne (blue) are in the upper part of the figure,the Vosges (Orange) in middle part and for the Plaines(red) in the lower part.
}
	\label{alti_sco}
\end{figure}
...
In Ardenne and in the Plaines, there is principally pure even aged stand of norway spruce but in the Vosges the stand are more mixed.
...
Bark beetle attack norway spruce with same proportion south facing slope and north facing slope in the Ardenne and in the Vosges.
