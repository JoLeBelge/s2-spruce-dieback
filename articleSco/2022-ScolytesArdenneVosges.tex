...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Vosges  & 4,305    &\surfEPVosges                                                                          & 5.7                                                                        \\ \hline
...
The variation of the dieback rate during 2017-2022  for the three bioclimatic regions shows an important effect of altitude but with some difference according to the region (Figure \ref{alti_sco}). More dieback was observed at low altitude :  at the height of the crisis, the probability of new dieback exceeded 20\% each year in the altitude class under 300 m.
...
\centering
	\includegraphics[width=\textwidth]{synthese_color_11_2022.png}
     \caption{Variation of the dieback rate from 2017 to 2022 according to the altitude which has been subdivided into 14 altitude classes of 100 m amplitude for the three regions: Plains (red), Ardenne (blue) and Vosges (orange. The area of spruce per altitude class is represented in black.  
}
	\label{alti_sco}
\end{figure}
...
However, we found that the Vosges lost 5.7\% of their spruce area. However, according to \citep{piedallu_spatial_2022} vulnerability maps, 33\% of spruce stands are located in areas at high risk of dieback. It is therefore likely that new stands will dieback in the years to come.
...
According to \citep{nardi_drought_2022}, the damage during 2018 is assessed at 1185 ha for the Grand-Est based on remote sensing methodology. In our health map for the year 2018, we found a total 1360 ha attacked in this administrative region.
In Wallonia, Saintonge et al. \citep{saintonge_situation_2022} estimate that the area of bark beetle spruce between 2018 and 2021 in Wallonia is around 5,000 ha, based on sales catalogues in public forests, and multiplying the volumes by two to account for private forests.
