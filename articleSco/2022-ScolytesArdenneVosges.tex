...
The variation of the dieback ratio in the three groups climatic area for the period 2017-2021 is described in the Figure \ref{alti_sco}.
...
Indeed, during 2018, the a strong increase of the dieback ratio in the 100-200m and 200-300m altitude classes is observed. 
...
In Vosges group, the altitude classes are affected by dieback in a similar way.
...
The diaback ratio is inferior of 5 \% during the study period.
...
The cumulative killed areas of Norways pruce area in function of the topographic orientation is present in the Figure \ref{tab_or_topo}
...
For this two area, is not the orientation that influence the dieback but the topography.
