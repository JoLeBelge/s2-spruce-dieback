...
It is naturally present in part of the Grand-Est (Vosges mountains, France) and artificially in Wallonia (Belgium), where it was introduced during the second half of the 19th century \citep{Noirfalise_1975}.
...
Pheromone trap systems are commercialized to fight bark beetles but they failed to limit the damage in case of bark beetle outbreak \citep{kuhn_pheromone_2022}.
...
The detection of bark beetle infestation is realized by using dense time series of S2 imagery following the methodology developped by \cite{dutrieux_package_2021}.
