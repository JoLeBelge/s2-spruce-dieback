...
\begin{enumerate}
	...
	\item ; dépérissement
	%code 3
	\item ; coupé mais sans dépérissement détecté avant la coupe
	%code 4
	\item ; coupé après avoir été dépérissant
	%code 5
	\item ; stress passager, donc à priori plus un stress lié à un déficit hydrique estival qu'à une attaque de scolyte.
	%code 6
	\item ; pixel qui est un mélange, détecté car présente un stress passager en hiver (feuillus sans photosynthèse) suivi d'un retour à la normale en été (résineux + feuillus en photosynthèse)
\end{enumerate}
