...
%bofbof
L'ensemble de la méthodologie de calcul des cartes d'états sanitaires est présente dans le  Guide méthodologique: Analyse des séries temporelles d'image Sentinel-2 pour la détection des épicéas scolytés. %\cite{
